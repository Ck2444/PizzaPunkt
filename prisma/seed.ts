...
async function up() {
  ...
  const pizza3 = await prisma.product.create({
    data: {
      name: 'Chorizo Frisch',
      imageUrl:
        'https://media.dodostatic.net/image/r:1875x1875/0198bf4f806371f19d529f9e9e7dba36.avif',
      categoryId: 1,
      ingredients: {
