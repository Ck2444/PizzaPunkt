      ...
      <SliderPrimitive.Root
        ...
        {localValues.map((value, index) => (
          <React.Fragment key={index}>
            ...
            <SliderPrimitive.Thumb className=" block h-4 w-4 rounded-full border border-solid border-[#d6a98f] bg-white shadow transition-colors hover:border-[#FE5F00]! hover:bg-[#FE5F00]! focus-visible:outline-none focus-visible:ring-0 disabled:pointer-events-none disabled:opacity-50 cursor-pointer" />
          </React.Fragment>
        ))}
      </SliderPrimitive.Root>
    );
